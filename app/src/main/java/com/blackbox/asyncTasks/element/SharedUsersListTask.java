...
public class SharedUsersListTask extends AsyncTask<Void, Void, ResponseBody> {

    private String URL = NetworkUtils.SERVICES_URL + "/element/listOfSharedUsers";
    ...
    public SharedUsersListTask(String userId, String elementName, String path) {
        this.userId = userId;
    ...
    protected void onPostExecute(final ResponseBody responseBody) {
        try {
            ...
            HomeActivity.getSharedUsersListTaskResult(result);
        }
